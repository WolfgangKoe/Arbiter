...
**Vorbedingung aus Ziel 6:** Das Game-Log-Format (strukturierte JSON mit `attacker_unit`, `target_unit`, `target_destroyed` pro Event) wird bereits in Ziel 6 etabliert. Ziel 8 baut darauf auf — kein separates Kill-Tracking mehr nötig.
