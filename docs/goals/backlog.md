...
- 🔲 **Silent-King-Zielaufteilung Fernkampf (S79-UI-Befund):** Ein Modell mit **zwei** Fernkampfwaffen (Silent King: Sceptre of Eternal Glory / Staff of Stars) kann aktuell nur **eine** Feind-Einheit als Ziel wählen. **Regelfrage:** Dürfen verschiedene Waffen **eines** Modells auf **verschiedene** Ziele aufgeteilt werden (sicher: alle Attacken **einer** Waffe auf dieselbe Einheit)? → Core-Rules (Shooting Phase / Select Targets) prüfen, Regressionstest anlegen, ggf. UI auf **Ziel-pro-Waffe** anpassen. Regelkonformität.
