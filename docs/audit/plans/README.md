...
| 009 | Modellgruppen: Duplikat-IDs mergen, unbekannte Weapon-Refs laut melden | P2 | S | — | TODO |
| 010 | Tote Variablen entfernen + F841-Lint-Gate scharf schalten | P2 | S | — (vor 008) | TODO |
| 006 | `yaml.safe_load` → `load_yaml`-Helper mit klarer Fehlermeldung | P2 | M | — | TODO |
| 007 | Scenario-Namen gegen Allowlist validieren (Pfad-Traversal) | P2 | S | — | TODO |
