...
| [024](024-arkana-protocol-effect-modeling.md) | Directive-Wiring (9 Protokoll-Direktiven) + Arkana-Schema + 1 Dispatch-Pilot (Failsafe) | P2 (MITTEL-HOCH) | M | 021 ✅ | **🟡 IN PROGRESS — Steps 1–4 DONE S86** (strength/ap/move/leadership-Direktiven + rerolls + advance_and_charge + RP-Modifikatoren; 4 Commits, +13 Unit-Tests, INV-4b grün). **Offen: Steps 5–7** (Failsafe-Dispatch-Pilot + strukturiertes Arkana-Schema + Doku). Arkana-Recherche-Digest liegt vor (Sonnet, S86): **alle 12 Punktkosten +5 zu hoch** vs. Wahapedia, nicht nur 3. 10/12 Arkana bleiben begründet `descriptive`. |

**Empfohlene Reihenfolge (akt. S86, 2026-06-22): 019·023·022·014·020·021 DONE → 024 (Steps 1–4 ✅, 5–7 offen) → 016 → 018 → 015 → 017.**
024 als Nächstes: Steps 5–7 — Failsafe-Dispatch-Pilot + Arkana-Schema (Direktiv-Wiring Steps 1–4 erledigt; **voller Testnetz-Mandat bleibt: Unit + Acceptance + INV-4b + manuelle UI + Doku**).
